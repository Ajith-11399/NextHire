...
const RelatedJobs = ({ job }) => {
    ...
    return (
        <div className='flex flex-col md:flex-row items-start md:items-center justify-between border p-6 rounded-2xl'>
            <div>
            ...
            <div className='flex md:flex-col gap-4 text-sm mt-4'>
                ...
                <button onClick={ ()=> {navigate(`/apply-job/${job._id}`); scrollTo(0, 0)}} className='bg-gradient-to-r from-white to-slate-300 text-black border px-4 py-2 rounded shadow-lg'> 
                    Learn More
                </button>
            </div>
        </div>
